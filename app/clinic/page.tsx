...
export default async function ClinicPage() {
  ...
  return (
    <>
      ...
      <div style={{
        height:'96px',
        backgroundImage:"url('/photos/interior/interior-1.jpg')",
        ...
        <div style={{position:'absolute',inset:0,background:'linear-gradient(90deg,rgba(143,166,192,0.88) 0%,rgba(159,184,214,0.88) 45%,rgba(183,210,234,0.88) 100%)',zIndex:0}} />
        ...
        <a href="/clinic/booking" style={{position:'relative',zIndex:1,
