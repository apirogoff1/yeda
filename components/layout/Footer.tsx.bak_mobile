...
export default function Footer() {
  return (
    <footer style={{ background: "transparent", position: "relative", overflow: "hidden", marginTop: "0px" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "64px 32px 28px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr 1fr 1fr 1fr", gap: "40px", alignItems: "start" }}>
